...
export default function Navbar() {
    const navItems = <>
    <li><NavLink className={({isActive})=> isActive ? 'border-b-2 border-blue-400 p-2 capitalize text-xl inline-block rounded-none text-blue-600' : "text-blue-400 capitalize"} to="/">event details</NavLink></li>
